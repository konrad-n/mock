...
namespace SledzSpecke.Tests.Helpers;
...
public class DateCalculatorTests
{
    ...
    public void CalculateWorkingDays_WeekdaysOnly_ReturnsCorrectCount()
    {
        ...
        DateTime startDateForCalculation = new DateTime(2023, 1, 2, 0, 0, 0, DateTimeKind.Local); // Monday
        DateTime endDate = new DateTime(2023, 1, 6, 0, 0, 0, DateTimeKind.Local);   // Friday

        // Act
        int workingDays = DateCalculator.CalculateWorkingDays(startDateForCalculation, endDate);
    ...
    {
        // Arrange
        DateTime startDateForCalculation = new DateTime(2023, 1, 7, 0, 0, 0, DateTimeKind.Local); // Saturday

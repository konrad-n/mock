// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InternshipLocationVisibilityConverter.cs" company="SledzSpecke">
//   Copyright (c) PlaceholderCompany. All rights reserved.
// </copyright>
// <summary>
//   Konwerter widoczności lokalizacji stażu.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace SledzSpecke.App.Common.Converters
{
    ...
    {
        /// <summary>
        /// Konwertuje informacje o stażu na wartość określającą widoczność informacji o lokalizacji.
        /// </summary>
        ...
        /// <returns>Wartość true, jeśli informacja o lokalizacji powinna być widoczna, w przeciwnym razie false.</returns>
